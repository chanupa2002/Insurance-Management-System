...
<?php 
    ...
    while ($user = mysqli_fetch_assoc($users)) {
        if($user['approval']==1){
            ...
            $user_list .= "<td><a href=\"adminMarkPayment.php?user_id={$user['cusId']}\"><button class='pay'>Upadate</button></a></td>";
            $user_list .= "</tr>";
        }
    }
 ?>
...
<!-- Search form -->
<div class="search">
    <form action="adminPayments.php" method="get">
...
<main>
    ...
    <table class="masterlist">
        <tr>
            ...
            <th class="rotatecell"><div>December</div></th>
            <th id="lastcell">Mark Payments</th>
        </tr>

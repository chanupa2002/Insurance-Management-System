...
while ($user = mysqli_fetch_assoc($users)) {
    ...
    if($user['approval']==1){
        ...
        // Adding a button to change details for each user
        $user_list .= "<td><a href=\"adminChangeDetails.php?user_id={$user['cusName']}\" ><button class='change'>Change</button></a></td>";
        $user_list .= "</tr>";
    }
}
...
<head>
    ...
    <link rel="stylesheet" href="css/admincustomerDetails.css">
...
<body>
    ...
    <main>
        <!-- User table -->
        <table class="masterlist" id="userTable">
            <tr>
                <th>Customer Id</th>
                <th>Name</th>
                <th>Email</th>
                ...
                <th>Gender</th>
                <th>Package</th>
                <th id="lastcell">Change Details</th>
            </tr>
        ...
        <button onclick="printTable()" id="printbtn">Print Table</button>
    </main>

    <script src="js/printCusDetails.js"></script>
